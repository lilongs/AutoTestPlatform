...
namespace WindowsFormsControlLibrary
{
    ...
    public partial class UserCurve : UserControl
    {
        ...
        private void UserCurve_Paint( object sender, PaintEventArgs e )
        {
            ...
            // 绘制倒三角
            SoftPainting.PaintTriangle( g, brush_deep, new Point( leftRight - 1, upDowm - 8 ), 4, GraphDirection.Upward );
            SoftPainting.PaintTriangle( g, brush_deep, new Point( width_totle - leftRight, upDowm - 8 ), 4, GraphDirection.Upward );
